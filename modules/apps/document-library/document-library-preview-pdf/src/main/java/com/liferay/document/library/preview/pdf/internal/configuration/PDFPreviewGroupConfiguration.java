...
@Meta.OCD(
	id = "com.liferay.document.library.preview.pdf.internal.configuration.PDFPreviewGroupConfiguration",
	localization = "content/Language",
	name = "pdf-preview-group-configuration-name"
)
public interface PDFPreviewGroupConfiguration {
