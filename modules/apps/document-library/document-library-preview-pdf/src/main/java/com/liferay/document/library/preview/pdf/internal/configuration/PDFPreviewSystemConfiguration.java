...
@Meta.OCD(
	id = "com.liferay.document.library.preview.pdf.internal.configuration.PDFPreviewSystemConfiguration",
	localization = "content/Language",
	name = "pdf-preview-system-configuration-name"
)
public interface PDFPreviewSystemConfiguration {
