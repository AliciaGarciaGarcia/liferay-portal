						...
						<c:choose>
							<c:when test='<%= displayStyle.equals("icon") %>'>
								...
								<c:if test="<%= fileEntry != null %>">
									...
									boolean isEditable = repositoryEntryBrowserDisplayContext.isEditable(latestFileVersion);
										...
										<c:choose>
											<c:when test="<%= Validator.isNull(thumbnailSrc) %>">
												<liferay-frontend:icon-vertical-card
													actionJsp='<%= isEditable ? "/repository_entry_browser/action_button_preview.jsp" : StringPool.BLANK %>'
													actionJspServletContext="<%= application %>"
													cardCssClass="card-interactive"
													cssClass='<%= (isEditable ? "item-preview" : StringPool.BLANK) + " file-card form-check form-check-card" %>'
													data="<%= data %>"
											...
											<c:otherwise>
												<liferay-frontend:vertical-card
													...
													actionJspServletContext="<%= application %>"
													cardCssClass="card-interactive"
													cssClass='<%= (isEditable ? "item-preview" : StringPool.BLANK) + " form-check form-check-card image-card" %>'
													data="<%= data %>"
