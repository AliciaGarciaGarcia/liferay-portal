...
public class KnowledgeBaseFragmentRenderer extends BaseContentFragmentRenderer {
	...
	public void render(
		...
		try {
			for (int i = 0; i < displayObject.getSize(); i++) {
				Object object = displayObject.getObject(i);
			...
			_log.error(
				"Unable to render content knowledge base navigation fragment",
				exception);
		}
	}
