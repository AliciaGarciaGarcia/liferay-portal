...
public class ScopeSerDes {
	...
	public static String toJSON(Scope scope) {
		...
		if (scope.getScopeKey() != null) {
			...
			sb.append(_escape(scope.getScopeKey()));
	...
	public static Map<String, String> toMap(Scope scope) {
		...
		if (scope.getId() == null) {
			...
			map.put("id", String.valueOf(scope.getId()));
		}
		...
		if (scope.getScopeKey() == null) {
			...
			map.put("scopeKey", String.valueOf(scope.getScopeKey()));
		}
	...
	public static class ScopeJSONParser extends BaseJSONParser<Scope> {
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "externalReferenceCode")) {
				...
				if (jsonParserFieldValue != null) {
					scope.setId(Long.valueOf((String)jsonParserFieldValue));
				}
			}
			else if (Objects.equals(jsonParserFieldName, "scopeKey")) {
				if (jsonParserFieldValue != null) {
					scope.setScopeKey((String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "type")) {
				if (jsonParserFieldValue != null) {
