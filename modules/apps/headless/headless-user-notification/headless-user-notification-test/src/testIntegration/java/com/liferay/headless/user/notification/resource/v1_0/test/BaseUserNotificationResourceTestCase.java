...
public abstract class BaseUserNotificationResourceTestCase {
	...
	public void testGetMyUserNotificationsPageWithPagination()
		...
		Page<UserNotification> totalPage =
			userNotificationResource.getMyUserNotificationsPage(null);
	...
	@Test
	public void testGetMyUserNotificationsReadPage() throws Exception {
		Page<UserNotification> page =
			userNotificationResource.getMyUserNotificationsReadPage(
				Pagination.of(1, 10));

		long totalCount = page.getTotalCount();

		UserNotification userNotification1 =
			testGetMyUserNotificationsReadPage_addUserNotification(
				randomUserNotification());
		...
		page = userNotificationResource.getMyUserNotificationsReadPage(
			Pagination.of(1, 10));
	...
	@Test
	public void testGetMyUserNotificationsReadPageWithPagination()
		throws Exception {

		Page<UserNotification> totalPage =
			userNotificationResource.getMyUserNotificationsReadPage(null);
	...
	@Test
	public void testGetMyUserNotificationsUnreadPage() throws Exception {
		Page<UserNotification> page =
			userNotificationResource.getMyUserNotificationsUnreadPage(
				Pagination.of(1, 10));

		long totalCount = page.getTotalCount();

		UserNotification userNotification1 =
			testGetMyUserNotificationsUnreadPage_addUserNotification(
				randomUserNotification());
		...
		page = userNotificationResource.getMyUserNotificationsUnreadPage(
			Pagination.of(1, 10));
	...
	@Test
	public void testGetMyUserNotificationsUnreadPageWithPagination()
		throws Exception {

		Page<UserNotification> totalPage =
			userNotificationResource.getMyUserNotificationsUnreadPage(null);
	...
	@Test
	public void testGetMyUserNotification() throws Exception {
		UserNotification postUserNotification =
			testGetMyUserNotification_addUserNotification();

		UserNotification getUserNotification =
			userNotificationResource.getMyUserNotification(
	...
	protected UserNotification testGetMyUserNotification_addUserNotification()
		throws Exception {
	...
	@Test
	public void testGraphQLGetMyUserNotification() throws Exception {
		UserNotification userNotification =
			testGraphQLGetMyUserNotification_addUserNotification();
					...
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								...
								getGraphQLFields())),
						"JSONObject/data", "Object/myUserNotification"))));
	}

	@Test
	public void testGraphQLGetMyUserNotificationNotFound() throws Exception {
	...
	@Test
	public void testPutMyUserNotificationRead() throws Exception {
		@SuppressWarnings("PMD.UnusedLocalVariable")
		UserNotification userNotification =
			testPutMyUserNotificationRead_addUserNotification();

		assertHttpResponseStatusCode(
			204,
			userNotificationResource.putMyUserNotificationReadHttpResponse(
				userNotification.getId()));

		assertHttpResponseStatusCode(
			404,
			userNotificationResource.putMyUserNotificationReadHttpResponse(0L));
	}
	...
	@Test
	public void testPutMyUserNotificationUnread() throws Exception {
		@SuppressWarnings("PMD.UnusedLocalVariable")
		UserNotification userNotification =
			testPutMyUserNotificationUnread_addUserNotification();

		assertHttpResponseStatusCode(
			204,
			userNotificationResource.putMyUserNotificationUnreadHttpResponse(
				userNotification.getId()));
