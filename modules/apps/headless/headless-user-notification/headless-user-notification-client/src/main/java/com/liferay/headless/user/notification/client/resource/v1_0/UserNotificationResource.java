...
public interface UserNotificationResource {
	...
	public HttpInvoker.HttpResponse getMyUserNotificationsReadPageHttpResponse(
			Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getMyUserNotificationsUnreadPageHttpResponse(Pagination pagination)
		throws Exception;

	public UserNotification getMyUserNotification(Long userNotificationId)
		throws Exception;

	public HttpInvoker.HttpResponse getMyUserNotificationHttpResponse(
	...
	public HttpInvoker.HttpResponse putMyUserNotificationReadHttpResponse(
			Long userNotificationId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putMyUserNotificationUnreadHttpResponse(
			Long userNotificationId)
		throws Exception;
	...
	public static class UserNotificationResourceImpl
		...
		public Page<UserNotification> getMyUserNotificationsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getMyUserNotificationsPageHttpResponse(pagination);
		...
		public Page<UserNotification> getMyUserNotificationsReadPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getMyUserNotificationsReadPageHttpResponse(pagination);
		...
		public HttpInvoker.HttpResponse
				getMyUserNotificationsReadPageHttpResponse(
					Pagination pagination)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-user-notification/v1.0/my-user-notifications/read");
		...
		public Page<UserNotification> getMyUserNotificationsUnreadPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getMyUserNotificationsUnreadPageHttpResponse(pagination);
		...
		public HttpInvoker.HttpResponse
				getMyUserNotificationsUnreadPageHttpResponse(
					Pagination pagination)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-user-notification/v1.0/my-user-notifications/unread");
		...
		public UserNotification getMyUserNotification(Long userNotificationId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getMyUserNotificationHttpResponse(userNotificationId);
		...
		public HttpInvoker.HttpResponse getMyUserNotificationHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-user-notification/v1.0/my-user-notifications/{userNotificationId}");
		...
		public void putMyUserNotificationRead(Long userNotificationId)
			...
			HttpInvoker.HttpResponse httpResponse =
				putMyUserNotificationReadHttpResponse(userNotificationId);
		...
		public HttpInvoker.HttpResponse putMyUserNotificationReadHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-user-notification/v1.0/my-user-notifications/{userNotificationId}/read");
		...
		public void putMyUserNotificationUnread(Long userNotificationId)
			...
			HttpInvoker.HttpResponse httpResponse =
				putMyUserNotificationUnreadHttpResponse(userNotificationId);
		...
		public HttpInvoker.HttpResponse putMyUserNotificationUnreadHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-user-notification/v1.0/my-user-notifications/{userNotificationId}/unread");
