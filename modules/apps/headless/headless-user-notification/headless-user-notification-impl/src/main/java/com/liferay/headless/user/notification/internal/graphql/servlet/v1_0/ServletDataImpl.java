	...
	private static final Map<String, ObjectValuePair<Class<?>, String>>
		_resourceMethodObjectValuePairs =
			new HashMap<String, ObjectValuePair<Class<?>, String>>() {
				{
					put(
						"mutation#updateMyUserNotificationRead",
						new ObjectValuePair<>(
							UserNotificationResourceImpl.class,
							"putMyUserNotificationRead"));
					put(
						"mutation#updateMyUserNotificationUnread",
						new ObjectValuePair<>(
							UserNotificationResourceImpl.class,
							"putMyUserNotificationUnread"));
					...
					put(
						"query#myUserNotificationsRead",
						new ObjectValuePair<>(
							UserNotificationResourceImpl.class,
							"getMyUserNotificationsReadPage"));
					put(
						"query#myUserNotificationsUnread",
						new ObjectValuePair<>(
							UserNotificationResourceImpl.class,
							"getMyUserNotificationsUnreadPage"));
					put(
						"query#myUserNotification",
						new ObjectValuePair<>(
							UserNotificationResourceImpl.class,
							"getMyUserNotification"));
				}
			};
