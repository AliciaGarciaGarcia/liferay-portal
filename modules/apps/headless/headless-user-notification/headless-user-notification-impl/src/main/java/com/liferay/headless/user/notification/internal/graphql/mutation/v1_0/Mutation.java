...
public class Mutation {
	...
	public boolean updateMyUserNotificationRead(
		...
		_applyVoidComponentServiceObjects(
			...
			userNotificationResource ->
				userNotificationResource.putMyUserNotificationRead(
					userNotificationId));
	...
	public boolean updateMyUserNotificationUnread(
			@GraphQLName("userNotificationId") Long userNotificationId)
		throws Exception {
		...
		_applyVoidComponentServiceObjects(
			...
			this::_populateResourceContext,
			userNotificationResource ->
				userNotificationResource.putMyUserNotificationUnread(
					userNotificationId));
