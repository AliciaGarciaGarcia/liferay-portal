...
public class UserModelListenerTest {
	...
	public void testAddUser() throws Exception {
		...
		ticket1 = _addInviteCollaboratorTicketWithExtraInfo(
			_group1.getGroupId(), null);
		ticket2 = _addInviteCollaboratorTicketWithExtraInfo(
		...
		User user5 = _addUser(emailAddress1);

		ticket1 = _addInviteCollaboratorTicket(
			_group1.getGroupId(), emailAddress1);

		sharingEntry1 = _sharingEntryLocalService.addSharingEntry(
			null, TestPropsValues.getUserId(), 0, 0, user5.getUserId(),
		...
		_userLocalService.updateStatus(
			user5.getUserId(), WorkflowConstants.STATUS_APPROVED,
			ServiceContextTestUtil.getServiceContext(
				_group1.getGroupId(), TestPropsValues.getUserId()));
	...
	private Ticket _addInviteCollaboratorTicket(
		...
		return _addInviteCollaboratorTicketWithExtraInfo(classPK, emailAddress);
	}

	private Ticket _addInviteCollaboratorTicketWithExtraInfo(
