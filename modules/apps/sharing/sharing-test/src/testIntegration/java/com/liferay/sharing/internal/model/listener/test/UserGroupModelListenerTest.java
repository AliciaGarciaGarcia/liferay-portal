...
public class UserGroupModelListenerTest {
	...
	@Test
	@TestInfo("LPD-48130")
	public void testDeletingUserGroupDeletesSharingEntries() throws Exception {
		UserGroup userGroup1 = UserGroupTestUtil.addUserGroup();
		UserGroup userGroup2 = UserGroupTestUtil.addUserGroup();

		_addToUserGroupIdSharingEntry(
			_group.getGroupId(), userGroup1.getUserGroupId());
		_addToUserGroupIdSharingEntry(
			_group.getGroupId(), userGroup2.getUserGroupId());
	...
	private void _addToUserGroupIdSharingEntry(long classPK, long toUserGroupId)
		throws Exception {
