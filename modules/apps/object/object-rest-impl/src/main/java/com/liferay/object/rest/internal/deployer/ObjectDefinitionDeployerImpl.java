...
public class ObjectDefinitionDeployerImpl implements ObjectDefinitionDeployer {
	...
	private InvitedCollaboratorResourceImpl
		...
		return new InvitedCollaboratorResourceImpl(
			_dtoConverterRegistry, _invitedCollaboratorDTOConverter,
			_objectEntryLocalService, _ticketLocalService);
	}
	...
	@Reference(
		target = "(dto.class.name=com.liferay.object.rest.dto.v1_0.InvitedCollaborator)"
	)
