...
public class InvitedCollaborator implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "If the invited collaborator can share or not the asset."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The invited collaborator type.", example = "User"
	)
	...
	@GraphQLField(description = "The invited collaborator type.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.object.rest.dto.v1_0.InvitedCollaborator",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-2087237718