 ...
 */
@Component(
	property = "repository.target.class.name=com.liferay.portal.kernel.objectentryportletfilerepository.ObjectEntryPortletFileRepository",
	service = RepositoryFactory.class
)
public class ObjectEntryPortletFileRepositoryFactory
