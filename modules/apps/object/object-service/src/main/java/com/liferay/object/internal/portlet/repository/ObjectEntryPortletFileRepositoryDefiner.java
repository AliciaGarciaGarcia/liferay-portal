...
package com.liferay.object.internal.portlet.repository;
...
public class ObjectEntryPortletFileRepositoryDefiner
	...
	public void registerCapabilities(
		...
		capabilityRegistry.addSupportedCapability(
			FileEntryValidatorCapability.class,
			_portalCapabilityLocator.getFileEntryValidatorCapability());
	...
	@Reference(
		target = "(repository.target.class.name=com.liferay.portal.kernel.objectentryportletfilerepository.ObjectEntryPortletFileRepository)"
	)
