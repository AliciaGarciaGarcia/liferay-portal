...
TranslateDisplayContext journalTranslateDisplayContext = new TranslateDisplayContext(liferayPortletRequest, liferayPortletResponse);
...
<aui:form action="<%= journalTranslateDisplayContext.getUpdateTranslationPortletURL() %>" cssClass="translate-infoItem" name="translate_fm">
