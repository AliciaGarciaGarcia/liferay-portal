...
public class TranslateDisplayContext {
	...
	public TranslateDisplayContext(
		...
		_infoItem = _httpServletRequest.getAttribute(
		...
		_sourceLanguageId = (String)_httpServletRequest.getAttribute(
			TranslationWebConstants.SOURCE_LANGUAGE_ID);
		...
		_targetLanguageId = (String)_httpServletRequest.getAttribute(
			TranslationWebConstants.TARGET_LANGUAGE_ID);
	...
	public String getTitle() {
		return "este deberia ser el titulo"; //_article.getTitle(PortalUtil.getLocale(_httpServletRequest));
	}
	...
	public PortletURL getUpdateTranslationPortletURL() {
		...
		//		portletURL.setParameter(/journal/update_translation
