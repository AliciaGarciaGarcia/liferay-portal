...
/**
 * Provides the local service interface for DLFileEntryFriendlyURL. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DLFileEntryFriendlyURLLocalServiceUtil
 * @generated
 */
@CTAware
@ProviderType
...
public interface DLFileEntryFriendlyURLLocalService
	extends BaseLocalService, CTService<DLFileEntryFriendlyURL>,
			PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portlet.documentlibrary.service.impl.DLFileEntryFriendlyURLLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dl file entry friendly url local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DLFileEntryFriendlyURLLocalServiceUtil} if injection and service tracking are not available.
	 */
